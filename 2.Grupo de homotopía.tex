...
\end{tikzcd}
\]
i.e., $\alpha=\hat{\alpha}\circ p$, definimos $\bdot{p}:[\alpha]\mapsto[\hat{\alpha}]$. Para ver que $\p$ está bien definida, sea $\alpha,\beta:(I^q,\partial I^q)\to (X,x_0)$ continuas, tal que $\alpha\simeq \beta$, i.e., existe $H:\Iq\to X$ continua tal que $ H(s,0)=\alpha(s)$, $H(s,1)=\beta(s)$ y
\begin{align*}
